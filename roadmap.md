...
- [ ] Redesign all SAP module and server detail pages from the hero through every content section
- [ ] Add a lightweight technical graphic to the SAP Easy Access panel across module pages
- [ ] Verify the shared redesign on mobile and desktop before rollout

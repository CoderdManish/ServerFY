...
export const serverPages: DetailPage[] = [
  ...
  },
  {
    slug: "dedicated",
    eyebrow: "SAP Servers",
    title: "Dedicated SAP servers",
    metaTitle: "Dedicated SAP Servers | Isolated Environments — ServerFY",
    intro:
      "Your own isolated SAP landscape with reserved compute, full client control and no other tenants sharing the system.",
    description:
      "Dedicated SAP server environments with reserved resources, isolated clients, full admin control and monitored uptime for teams and enterprises.",
    highlights: [
      { title: "Reserved resources", desc: "Compute and memory are yours alone, so performance never depends on other users.", icon: "ShieldCheck" },
      { title: "Full client control", desc: "Create clients, users and roles exactly the way your project needs them.", icon: "Settings2" },
      { title: "Custom configuration", desc: "Keep your own customising, transports and developments across the whole term.", icon: "GitBranch" },
      { title: "Priority support", desc: "Direct line to an infrastructure engineer during your working hours.", icon: "Headset" },
    ],
    specs: [
      { label: "Isolation", value: "Single-tenant landscape, no shared clients" },
      { label: "Admin rights", value: "Client creation, user administration and transports" },
      ...commonAccessSpecs,
    ],
    checklist: {
      title: "Good fit for",
      items: [
        "Project teams working in parallel",
        "Corporate training with custom data",
        "Long-running development work",
        "Client-facing demo landscapes",
      ],
    },
    faq: commonFaq,
  },
  ...
  },
  {
    ...
    intro:
      "Hands-on environments built for repetition: run the same cycle as often as you like until the configuration truly sticks.",
    description:
      "Online SAP practice servers for students, job seekers and consultants — configure, run transactions and repeat real business cycles.",
    highlights: [
      { title: "Real transactions", desc: "Not screenshots or simulators — the actual SAP screens and t-codes.", icon: "MonitorPlay" },
      { title: "Repeatable cycles", desc: "Master data is ready so you can run order-to-cash or procure-to-pay again and again.", icon: "Repeat" },
      { title: "Any module", desc: "Pick one module or take a combined functional and technical environment.", icon: "Boxes" },
      { title: "Flexible duration", desc: "One month for a sprint of study, or longer while you job hunt.", icon: "CalendarClock" },
    ],
    specs: [
      { label: "Platform", value: "S/4HANA or ECC 6.0, your choice" },
    ...
    checklist: {
      ...
      items: [
        ...
        "Refreshing skills after a career break",
      ],
    },
    faq: commonFaq,
  },
  {
    ...
    intro:
      "Multi-user landscapes for trainers and institutes: one environment, a login for every learner, and a batch that starts on time.",
    description:
      "Multi-user SAP training servers for institutes and corporate trainers, with per-learner logins, batch provisioning and monitored uptime.",
    highlights: [
      { title: "Per-learner logins", desc: "Every participant gets their own user, so nobody overwrites anyone's work.", icon: "Users" },
      { title: "Batch provisioning", desc: "Tell us the size and start date; the logins are ready before day one.", icon: "GraduationCap" },
      { title: "Trainer oversight", desc: "An admin user to reset data, unlock users and prepare exercises.", icon: "Presentation" },
      { title: "Term-based pricing", desc: "Pay for the length of the batch, not a full year.", icon: "Wallet" },
    ],
    specs: [
      { label: "Users", value: "From 5 to 100+ concurrent learners" },
      { label: "Reset", value: "Data refresh between batches on request" },
      ...commonAccessSpecs,
    ],
    checklist: {
      title: "Good fit for",
  ...
  },
  {
    ...
    intro:
      "Development landscapes with developer keys, transport requests and package access so your team can build and move code properly.",
    description:
      "SAP development servers with ABAP Workbench, developer keys, transports and integration access for building extensions and custom apps.",
    highlights: [
      { title: "Developer keys", desc: "Registered developers and object keys issued with the environment.", icon: "KeyRound" },
      { title: "Transports", desc: "Proper package and transport handling instead of local objects only.", icon: "GitBranch" },
      { title: "Modern stack", desc: "CDS views, OData services, Fiori and UI5 tooling available.", icon: "Code2" },
      { title: "Integration ready", desc: "Outbound connectivity for APIs and middleware experiments on request.", icon: "Cable" },
    ],
    specs: [
      { label: "Stack", value: "ABAP Workbench, CDS, OData, Fiori tooling" },
      { label: "Team size", value: "Single developer up to a full squad" },
      ...commonAccessSpecs,
    ],
    checklist: {
      title: "Good fit for",
      items: [
        "Product teams building SAP extensions",
        "Freelance ABAP developers",
        "Fiori and UI5 app work",
  ...
  },
  {
    ...
    intro:
      "Isolated environments to validate configuration, run regression cycles and rehearse a rollout before it touches your real landscape.",
    description:
      "SAP testing environments for functional, regression and integration testing, with snapshots and clean resets between cycles.",
    highlights: [
      { title: "Safe isolation", desc: "Break things freely — nothing here touches your production system.", icon: "ShieldCheck" },
      { title: "Snapshots", desc: "Take a restore point before a cycle and roll back in minutes.", icon: "History" },
      { title: "Parallel clients", desc: "Run several test streams side by side without collisions.", icon: "Layers" },
      { title: "Short terms", desc: "Spin up for a test window and stop when the cycle closes.", icon: "CalendarClock" },
    ],
    specs: [
      { label: "Reset", value: "Snapshot and restore between cycles" },
      { label: "Clients", value: "Multiple clients for parallel streams" },
      ...commonAccessSpecs,
    ],
    checklist: {
      title: "Good fit for",
      items: [
        ...
        "UAT rehearsals",
        "Integration test rounds",
        "Training QA teams on SAP flows",
      ],
    },
    faq: commonFaq,
  },
  {
    ...
    intro:
      "Presentable environments for client demos and proofs of concept, with clean data, stable performance and a short activation window.",
    description:
      "Client-ready SAP demo and proof of concept environments with clean sample data, stable performance and short-term availability.",
    highlights: [
      { title: "Presentation ready", desc: "Clean, tidy data that looks right on a shared screen.", icon: "MonitorPlay" },
      { title: "Stable performance", desc: "Reserved capacity for the day of the demo so nothing stalls.", icon: "Gauge" },
      { title: "Short commitments", desc: "Take it for a week or a month — no long contract.", icon: "CalendarClock" },
      { title: "Reset on demand", desc: "Restore the demo baseline between prospects.", icon: "History" },
    ],
    specs: [
      { label: "Duration", value: "From one week upwards" },
      { label: "Data", value: "Clean demo baseline, restorable" },
      ...commonAccessSpecs,
    ],
    checklist: {
      title: "Good fit for",
      items: [
        ...
        "Investor and stakeholder walkthroughs",
